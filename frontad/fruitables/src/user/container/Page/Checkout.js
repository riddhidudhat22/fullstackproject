...
function Checkout(props) {
  ...
  <div className="container-fluid py-5">
    <div className="container py-5">
      <h1 className={`mb-4 ${themcontext.theme === 'dark' ? 'colorclass':''}`}>Billing details</h1>
      <form action="#">
        <div className="row g-5">
          ...
          <div className="col-md-12 col-lg-6 col-xl-5">
            <div className="table-responsive">
              <table className={`table ${themcontext.theme === 'dark' ? 'colorclass':''}`}>
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="py-5" />
                    <td className="py-5">
                      <p className={`mb-0  py-3 ${themcontext.theme === 'dark' ? 'colorclass':'text-dark'}`}>Subtotal</p>
                    </td>
                    <td className="py-5">
                      <div className="py-3 border-bottom border-top">
                        <p className={`mb-0  ${themcontext.theme === 'dark' ? 'colorclass':'text-dark'}`}>$414.00</p>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="py-5">
                      <p className={`mb-0 py-4 ${themcontext.theme === 'dark' ? 'colorclass':'text-dark'}`}>Shipping</p>
                    </td>
                  ...
                  <tr>
                    ...
                    <td className="py-5">
                      <p className={`mb-0  text-uppercase py-3 ${themcontext.theme === 'dark' ? 'colorclass':'text-dark'}`}>TOTAL</p>
                    </td>
                    <td className="py-5" />
                    <td className="py-5" />
                    <td className="py-5">
                      <div className="py-3 border-bottom border-top">
                        <p className={`mb-0 ${themcontext.theme === 'dark' ? 'colorclass':'text-dark'}`}>$135.00</p>
                      </div>
                    </td>
                  </tr>
                </tbody>
            ...
            <div className="row g-4 text-center align-items-center justify-content-center border-bottom py-3">
              <div className="col-12">
                ...
                <p className={`text-start ${themcontext.theme === 'dark' ? 'colorclass':'text-dark'}`}>Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order will not be shipped until the funds have cleared in our account.</p>
              </div>
            </div>
            <div className="row g-4 text-center align-items-center justify-content-center border-bottom py-3">
              <div className="col-12">
