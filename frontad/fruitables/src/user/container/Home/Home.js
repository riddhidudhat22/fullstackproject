...
import { getfacelity } from '../../../redux/action/facility.action';
...
function Home(props) {
    const testing = {
        ...
        navText: [
            ...
            '<div class="owl-next owl-prev"><i class="bi bi-arrow-right"></i></div'
        ],
    ...
    useEffect(() => {
        dispatch(getfacelity())
    }, [])

    const facelity = useSelector(state => state.facility)
    console.log(facelity);
    ...
    return (
        <div>
                    ...
                    <div className="tab-class text-center">
                        <div className="row g-4">
                            <div className="col-lg-4 text-start">
                                <h2 className={`${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>Our Organic Products</h2>
                                {/* ${themcontext.theme==='light'?'hero-header':null}` */}
                            </div>
                                        ...
                                        <div className="row g-4">
                                            <div className="col-md-6 col-lg-4 col-xl-3">
                                                <div className="rounded position-relative fruite-item">
                                                    ...
                                                    <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                                                        <h4 className={`${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>Grapes</h4>
                                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                                        <div className="d-flex justify-content-between flex-lg-wrap">
                                                            <p className={`fs-5 fw-bold mb-0 ${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>$4.99 / kg</p>
                                            ...
                                            <div className="col-md-6 col-lg-4 col-xl-3">
                                                <div className="rounded position-relative fruite-item">
                                                    ...
                                                    <div className="text-white bg-secondary px-3 py-1 rounded position-absolute" style={{ top: 10, left: 10 }}>Fruits</div>
                                                    <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                                                        <h4 className={`${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>Raspberries</h4>
                                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                                        <div className="d-flex justify-content-between flex-lg-wrap">
                                                            <p className={`fs-5 fw-bold mb-0 ${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>$4.99 / kg</p>
                                                            <a href="#" className="btn border border-secondary rounded-pill px-3 text-primary"><i className="fa fa-shopping-bag me-2 text-primary" /> Add to cart</a>
                                            ...
                                            <div className="col-md-6 col-lg-4 col-xl-3">
                                                <div className="rounded position-relative fruite-item">
                                                    ...
                                                    <div className="text-white bg-secondary px-3 py-1 rounded position-absolute" style={{ top: 10, left: 10 }}>Fruits</div>
                                                    <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                                                        <h4 className={`${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>Apricots</h4>
                                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                                        <div className="d-flex justify-content-between flex-lg-wrap">
                                                            <p className={`fs-5 fw-bold mb-0 ${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>$4.99 / kg</p>
                                                            <a href="#" className="btn border border-secondary rounded-pill px-3 text-primary"><i className="fa fa-shopping-bag me-2 text-primary" /> Add to cart</a>
                                            ...
                                            <div className="col-md-6 col-lg-4 col-xl-3">
                                                <div className="rounded position-relative fruite-item">
                                                    ...
                                                    <div className="text-white bg-secondary px-3 py-1 rounded position-absolute" style={{ top: 10, left: 10 }}>Fruits</div>
                                                    <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                                                        <h4 className={`${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>Banana</h4>
                                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                                        <div className="d-flex justify-content-between flex-lg-wrap">
                                                            <p className={`fs-5 fw-bold mb-0 ${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>$4.99 / kg</p>
                                                            <a href="#" className="btn border border-secondary rounded-pill px-3 text-primary"><i className="fa fa-shopping-bag me-2 text-primary" /> Add to cart</a>
                                            ...
                                            <div className="col-md-6 col-lg-4 col-xl-3">
                                                <div className="rounded position-relative fruite-item">
                                                    ...
                                                    <div className="text-white bg-secondary px-3 py-1 rounded position-absolute" style={{ top: 10, left: 10 }}>Fruits</div>
                                                    <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                                                        <h4 className={`${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>Oranges</h4>
                                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                                        <div className="d-flex justify-content-between flex-lg-wrap">
                                                            <p className={`fs-5 fw-bold mb-0 ${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>$4.99 / kg</p>
                                                            <a href="#" className="btn border border-secondary rounded-pill px-3 text-primary"><i className="fa fa-shopping-bag me-2 text-primary" /> Add to cart</a>
            ...
            <div className="container-fluid vesitable py-5">
                <div className="container py-5">
                    <h2 className={`${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>Fresh Organic Vegetables</h2>
                    <OwlCarousel {...vegetable} className="owl-carousel vegetable-carousel justify-content-center">
                        <div className="border border-primary rounded position-relative vesitable-item">
                            ...
                            <div className="p-4 rounded-bottom">
                                <h4 className={`${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>Parsely</h4>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                <div className="d-flex justify-content-between flex-lg-wrap">
                                    <p className={`fs-5 fw-bold mb-0${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>$4.99 / kg</p>
                                    <a href="#" className="btn border border-secondary rounded-pill px-3 text-primary"><i className="fa fa-shopping-bag me-2 text-primary" /> Add to cart</a>
                        ...
                        <div className="border border-primary rounded position-relative vesitable-item">
                            ...
                            <div className="p-4 rounded-bottom">
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                <div className="d-flex justify-content-between flex-lg-wrap">
                                    <p className={`fs-5 fw-bold mb-0${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>$7.99 / kg</p>
                                    <a href="#" className="btn border border-secondary rounded-pill px-3 text-primary"><i className="fa fa-shopping-bag me-2 text-primary" /> Add to cart</a>
                                </div>
                            </div>
                        </div>
                        <div className="border border-primary rounded position-relative vesitable-item">
                            ...
                            <div className="text-white bg-primary px-3 py-1 rounded position-absolute" style={{ top: 10, right: 10 }}>Vegetable</div>
                            <div className="p-4 rounded-bottom">
                                <h4 className={`${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>Bell Papper</h4>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                <div className="d-flex justify-content-between flex-lg-wrap">
                                    <p className={`fs-5 fw-bold mb-0${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>$7.99 / kg</p>
                                    <a href="#" className="btn border border-secondary rounded-pill px-3 text-primary"><i className="fa fa-shopping-bag me-2 text-primary" /> Add to cart</a>
                        ...
                        <div className="border border-primary rounded position-relative vesitable-item">
                            ...
                            <div className="text-white bg-primary px-3 py-1 rounded position-absolute" style={{ top: 10, right: 10 }}>Vegetable</div>
                            <div className="p-4 rounded-bottom">
                                <h4 className={`${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>Potatoes</h4>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                <div className="d-flex justify-content-between flex-lg-wrap">
                                    <p className={`fs-5 fw-bold mb-0${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>$7.99 / kg</p>
                                    <a href="#" className="btn border border-secondary rounded-pill px-3 text-primary"><i className="fa fa-shopping-bag me-2 text-primary" /> Add to cart</a>
            ...
            <div className="container-fluid py-5">
                <div className="container py-5">
                    <div className="text-center mx-auto mb-5" style={{ maxWidth: 700 }}>
                        <h2 className={`${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>Bestseller Products</h2>

                        <p>Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable.</p>
                    </div>
                    <div className="row g-4">
                        <div className="col-lg-6 col-xl-4">
                            <div className={`p-4 rounded ${themcontext.theme === 'dark' ? 'border border-secondary' : 'bg-light'}`}>
            ...
            <div className="container-fluid testimonial py-5">
                <div className="container py-5">
                    <div className="testimonial-header text-center">
                        ...
                        <h2 className={`${themcontext.theme === 'dark' ? 'colorclass' : ''}`}>Our Client Saying!</h2>
                    </div>
                    <OwlCarousel {...testing} className="owl-carousel testimonial-carousel">
                        <div className="testimonial-item img-border-radius  rounded p-4">
                            <div className="position-relative">
                                ...
                                <div className="mb-4 pb-4 border-bottom border-secondary">
                                    <p className={`mb-0 ${themcontext.theme === 'dark' ? 'colorclass' : 'text-black'}`}>Lorem Ipsum is simply dummy text of the printing Ipsum has been the industry's standard dummy text ever since the 1500s,
                                    </p>
                                </div>
                                <div className="d-flex align-items-center flex-nowrap">
                                    ...
                                    <div className="ms-4 d-block">
                                        <h4 className={` ${themcontext.theme === 'dark' ? 'colorclass' : 'text-dark'}`}>Client Name</h4>
                                        <p className='m-0 pb-3 text-black'>Profession</p>
