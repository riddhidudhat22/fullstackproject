...
import { reviewtdata } from '../../../redux/action/review.action';
import { useDispatch, useSelector } from 'react-redux';
import { addtocart, decress, incress } from '../../../redux/reducer/slice/addtocart.slice';
...
function Shopdetail(props) {
  ...
  const addTocart = () => {
    dispatch(addtocart({id,countqty}))
  }
    ...
    <div>
      ...
      <div className="container-fluid py-5 mt-5">
        <div className="container py-5">
          <div className="row g-4 mb-5">
              ...
              <div className="row g-4">
                <div className="col-lg-6">
                  <div className="border rounded">
                    <a href="#">
                      <img src={`../${shopDetails.img}`} className="img-fluid rounded" alt="Image" />
                    </a>
                  </div>
                </div>
                <div className="col-lg-6">
                  <h4 className={`fw-bold mb-3 ${themcontext.theme === 'dark' ? 'colorclass':''}`}>{shopDetails.name}</h4>
                  <p className="mb-3">{shopDetails.description}</p>
                  <h5 className={`fw-bold mb-3 ${themcontext.theme === 'dark' ? 'colorclass':''}`}>{shopDetails.price}$</h5>
                  ...
                  <div className="input-group quantity mb-5" style={{ width: 100 }}>
                    <div className="input-group-btn">
                      <button className="btn btn-sm btn-minus rounded-circle bg-light border" onClick={handaldecrement}>
                    ...
                    <div className="input-group-btn">
                      <button className="btn btn-sm btn-plus rounded-circle bg-light border" onClick={handalincrement} >
                  ...
                  {/* </NavLink> */}
                  {/* <NavLink to="/cart/" className="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary" ><i className="fa fa-shopping-bag me-2 text-primary"/> Add to cart</NavLink> */}
                </div>
            ...
            <div className="col-lg-4 col-xl-3">
              <div className="row g-4 fruite">
                ...
                <div className="col-lg-12">
                  <h4 className={`mb-4 ${themcontext.theme === 'dark' ? 'colorclass':''}`}>Featured products</h4>
          ...
          <h1 className={`fw-bold mb-0 ${themcontext.theme === 'dark' ? 'colorclass':''}`}>Related products</h1>
            ...
            <OwlCarousel {...vegetable} className="owl-carousel vegetable-carousel justify-content-center">
              <div className="border border-primary rounded position-relative vesitable-item">
                ...
                <div className="p-4 pb-0 rounded-bottom">
                  ...
                  <div className="d-flex justify-content-between flex-lg-wrap">
                    <p className={`fs-5 fw-bold ${themcontext.theme === 'dark' ? 'colorclass':'text-dark'}`}>$4.99 / kg</p>
              ...
              <div className="border border-primary rounded position-relative vesitable-item">
                ...
                <div className="p-4 pb-0 rounded-bottom">
                  ...
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                  <div className="d-flex justify-content-between flex-lg-wrap">
                    <p className={`fs-5 fw-bold ${themcontext.theme === 'dark' ? 'colorclass':'text-dark'}`}>$7.99 / kg</p>
                    <a href="#" className="btn border border-secondary rounded-pill px-3 py-1 mb-4 text-primary"><i className="fa fa-shopping-bag me-2 text-primary" /> Add to cart</a>
                  </div>
                </div>
              </div>
